...
$('#quitter_room').on('click', function() {
  ...
  /*document.getElementById('activeOnglet1').addClass("mdc-tab--active active");
  document.getElementById('activeOnglet2').removeClass("mdc-tab--active active");*/ //modifier ces 2 lignes pour remettre sur le bon onglet qd room quittée
